...
export default async function AdminReportsPage() {
    ...
    return (
        <AdminLayout
            ...
            action={
                <button className="flex items-center gap-2 px-4 py-2 border border-slate-700 text-slate-300 hover:text-white hover:border-slate-500 text-sm font-medium rounded-lg transition-all">
