...
export function Hero() {
  ...
  return (
    <div className="bg-gradient-to-b from-[#010816] to-[#0B1120] pb-10 pt-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="relative group">
            <div className="flex items-center bg-[#111827] rounded-full overflow-hidden p-1 pr-1 border border-indigo-500/30 focus-within:border-accent-gold/70 focus-within:ring-2 focus-within:ring-accent-gold/20 transition-all shadow-lg shadow-black/50">
