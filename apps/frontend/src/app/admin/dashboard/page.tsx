                                ...
                                <div key={c.title} className="p-5 hover:bg-white/5 transition-colors group">
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                        ...
                                        <div className="flex items-center gap-2 shrink-0">
                                            <Button variant="outline" className="px-3 py-1.5 h-8 text-xs font-medium text-indigo-300 hover:text-white border-indigo-500/30 hover:border-indigo-500 hover:bg-indigo-500/10 rounded-lg transition-all">Phân tích</Button>
                                            <Button className="px-3 py-1.5 h-8 text-xs font-medium text-white bg-indigo-600 hover:bg-indigo-500 rounded-lg transition-all">Chỉnh sửa</Button>
                                        </div>
                                    </div>
                                </div>
                            ))}
                            ...
                            {MOCK_QUESTIONS.map(q => (
                                <div key={q.name} className="bg-[#010816] rounded-lg p-4 border border-slate-800 hover:border-indigo-500/50 transition-colors">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <Button variant="link" className="text-xs h-auto p-0 flex items-center gap-1 text-slate-500 hover:text-amber-400 transition-colors">✦ Gợi ý AI</Button>
                                    </div>
                                </div>
                            ))}
                        </div>
